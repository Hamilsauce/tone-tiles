...
export class GraphNode extends EventEmitter {
  ...
  update(attributeMap = {}) {
    ...
    this.#context.emit('node:update', { id: this.id, data: patch });
...
export class Graph extends EventEmitter {
  ...
  constructor(map = []) {
    ...
    //   this.emit('node:update', { id: this.id, data: patch });
    // });
  }
  ...
  getNodeByAddress(address) {
    return this.#nodes.get(address) ?? this.#mapLinkNodes.get(address);
  }
