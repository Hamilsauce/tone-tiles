...
export class Graph {
  ...
  toStorageFormat() {
    const output = [...this.#nodes.values()].reduce((out, n, i) => {
      ...
      // console.warn(n.tileType)
      // console.warn('tileTypes[n.tileType]', tileTypes[n.tileType])
      if (n.tileType && !['empty'].includes(n.tileType)) {
