...
export const initMapControls = async (graph, svgCanvas, actor1, selectionBox) => {
  ...
  // stuff.graph = stuff.graph ?? graph;
  stuff.svgCanvas = stuff.svgCanvas ?? svgCanvas;
  stuff.actor1 = stuff.actor1 ?? actor1;
  stuff.selectionBox = stuff.selectionBox ?? selectionBox;
